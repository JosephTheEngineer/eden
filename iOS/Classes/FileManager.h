...
public:
    ...
    void convertFile(std::string file_name);
    std::string getName(std::string file_name);
    void setName(std::string fn,std::string dn);
    void setImageHash(std::string hash);
    void loadWorld(std::string name,BOOL fromArchive);
